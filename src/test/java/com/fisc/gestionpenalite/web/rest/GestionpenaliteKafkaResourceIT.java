...
import com.fisc.gestionpenalite.GestionpenaliteApp;
...
@SpringBootTest(classes = GestionpenaliteApp.class)
@DirtiesContext(classMode = DirtiesContext.ClassMode.BEFORE_CLASS)
public class GestionpenaliteKafkaResourceIT {
    ...
    @Autowired
    private GestionpenaliteKafkaProducer producer;

    @Autowired
    private GestionpenaliteKafkaConsumer consumer;
    ...
    @BeforeEach
    public void setup() {
        GestionpenaliteKafkaResource kafkaResource = new GestionpenaliteKafkaResource(producer);
    ...
    public void producedMessageHasBeenConsumed() throws Exception {
        restMockMvc.perform(post("/api/gestionpenalite-kafka/publish?message=test"))
