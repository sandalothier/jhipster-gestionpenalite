package com.fisc.gestionpenalite.config;
...
public class CacheConfiguration implements DisposableBean {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("gestionpenalite");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("gestionpenalite");
        ...
        config.getMapConfigs().put("com.fisc.gestionpenalite.domain.*", initializeDomainMapConfig(jHipsterProperties));
